...
1. **Expect a 20-25% deposit for a property up to AED 5 million, and 30-35% for anything above it.** The CBUAE headline rules are 20% for expat first-time buyers up to AED 5m and 30% above it, but most banks have layered a 5% conservative buffer on top. Up to AED 5m, budget 25%. Above AED 5m, budget 35%. For a second property (even if your first is in the UK), the CBUAE cap is 60% LTV, so 40%.
...
- First property, over AED 5m: max 70% LTV (30% deposit minimum). Unchanged from the 2020 CBUAE amendment.
...
Under CBUAE rules: 20% for a first property up to AED 5m, 30% for a first property over AED 5m, 40% for a second property. In practice most banks apply an additional 5% conservative buffer, so budget 25% for a sub-AED 5m first buy.
