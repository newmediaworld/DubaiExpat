...
The headline price is what gets advertised. The actual cash you need to close the deal is materially higher. For a typical AED 2M apartment purchase in Marina, financed at the 80% regulatory maximum set out above:

| Line | AED | Notes |
|---|---|---|
| Property purchase price | 2,000,000 | Headline |
| Down payment (20% on AED 2M) | 400,000 | Buyer's own funds; the regulatory minimum, not a bank promise |
...
| Mortgage registration fee (0.25% of loan) | 4,000 | Only if mortgaged |
| Mortgage processing fee (typically 1% of loan) | 16,000 | Bank-side |
| Property valuation fee | 2,500-4,000 | Bank-required |
| Title deed issuance | 250 | DLD |
| **Total cash at completion** | **~AED 546,000** | + 80% mortgage of 1.6M = ~AED 2.15M total deal value |

So roughly 27% of the headline price is the actual cash outlay, including a 20% down payment, ~7% transaction costs, and ~0.5% admin/registration. UK buyers consistently underestimate the 7% transaction layer.

One caveat on the down payment: 80% is the ceiling the Central Bank permits for an expat first home up to AED 5M, not an entitlement. Individual banks routinely lend less — 75% is common, which on this example puts AED 500,000 down and ~AED 646,000 cash at completion. Budget from the bank's offer, not the regulation.
