...
**Threshold:** Single property — or portfolio totalling AED 2,000,000+ on title deed / Oqood. Off-plan and ready properties both qualify. **Updated Feb 2026:** the federal circular issued in February 2026 removed the previous Dh1 million upfront-cash-payment requirement, so qualification is now based on the *total registered property value*, not the paid-up equity. A mortgaged property qualifies as long as the title-deed value clears AED 2M.
...
- Joint ownership: a per-owner minimum share is widely quoted for joint title deeds, but we have not been able to locate the figure on any UAE government source — it does not appear on the ICP or [u.ae](https://u.ae/en/information-and-services/visa-and-emirates-id/residence-visas) visa pages, and we have removed the specific number we previously carried here rather than repeat it unsourced. If you are buying jointly, confirm the current per-owner threshold directly with Dubai Land Department or an ICP-approved typing centre before you structure the purchase. Sole owners have no per-person minimum beyond the AED 2M total.
...
**5. Mortgage misunderstandings.** Until February 2026 the AED 2M threshold had to be paid-up equity — meaning a 75% LTV mortgage on a AED 2.5M property *did not* qualify even though the headline price was above AED 2M. The Feb 2026 federal circular changed that: qualification now follows the registered title-deed value, not the cash paid in. Older guides and property-agent decks still cite the paid-up-equity rule — that is now out of date.
