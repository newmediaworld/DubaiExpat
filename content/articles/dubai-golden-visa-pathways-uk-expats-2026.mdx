...
- Joint ownership: each named owner needs a registered share of at least AED 400,000 to qualify on a joint title deed (Feb 2026 federal-circular floor). Sole owners have no per-person minimum beyond the AED 2M total.
