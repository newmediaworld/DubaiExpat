...
- **HMRC Overseas Transfer Charge (OTC):** Since 2017, an OTC of 25% applies to transfers to a QROPS unless specific conditions are met (for example, both you and the QROPS are in the same country). **Changed at Autumn Budget 2024:** the EEA + Gibraltar exclusion that previously kept transfers to those jurisdictions out of the 25% charge was removed for transfers made **on or after 30 October 2024** — EEA-based QROPS now sit on the same OTC footing as the rest of the world. If the conditions change within five years of the transfer, the charge can still be applied retrospectively.
