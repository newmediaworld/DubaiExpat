...
- There was no **significant break** from your overseas work — a gap of 31 days or more in which you do no day of more than three hours' work
- You spent fewer than **91 days** in the UK across the tax year
- You worked for more than three hours in the UK on fewer than **31 days** across the tax year
...
The UK day-count is the critical number. "Fewer than 91 days" means the maximum you can spend in the UK is **90 days** — day 91 fails the test. Read the counting rules carefully:

- It's calendar days you were physically in the UK at midnight, not working days.
- It includes weekends, bank holidays, days you were sick in the UK, and any day you were still in the UK at midnight.
- A day you fly in on one evening and out the following morning is one midnight in the UK, so it counts as one day.
- A pure transit day — you arrive and leave without staying overnight and do nothing unrelated to your travel — is generally not counted at all under the transit exemption. Don't rely on that for anything marginal.
...
4. **90-day tie** — spent more than 90 days in the UK in either of the previous 2 tax years
...
The SRT has a "deeming rule" aimed at people who fly out before midnight to keep the day count down. It bites if all three apply: you have at least three UK ties, you were UK-resident in one or more of the previous three tax years, and you have more than 30 "qualifying days" — days you were present in the UK at some point but *not* at midnight. Once you pass 30 such days, every further one counts as a UK day even though you weren't there at midnight.

**Mitigation:** don't try to play tight margins. The ceiling under the third automatic overseas test is 90 days; if your workings put you at 88 or 89, leave a 7-10 day buffer rather than risking a misclassification.
...
- You were UK-resident in the tax year in question **and** in the previous tax year (Case 1 is designed for people leaving the UK, so prior-year residence is a condition, not a disqualifier)
- You are non-UK-resident in the *following* tax year because you meet the third automatic overseas test
- You satisfy the overseas work criteria from the day you first do more than three hours' work overseas to the end of the tax year
...
- UK rental income: UK-source, taxable in UK regardless of residency. As a British citizen you keep your UK personal allowance automatically (ITA 2007 s.56) — no election is needed. Form NRL1 is a separate thing: it asks HMRC to let your agent or tenant pay you the rent gross rather than deducting 20% at source.
- UK pension income: UK-source, taxable in UK by default; a treaty claim under the UK-UAE Convention can relieve it.
- UK dividend income: the UK levies **no** withholding tax on dividends. For a non-resident, UK dividends normally fall within the "disregarded income" rules, which cap the UK liability at the tax treated as deducted at source.
...
6. **Cutting it too fine on day-counts** — trying to maximise UK time at 89-90 days when the test requires fewer than 91. Leave a buffer.
...
If HMRC determines you were UK-resident when you thought you weren't, they can assess UK income tax on your Dubai earnings for the year(s) in question. A typical AED 50k/month Dubai package is AED 600,000 a year — roughly £125-130k at 2026 rates — and at UK higher and additional rates plus interest and penalties that can run to a £50-60k+ assessment per year of incorrect status. Not a minor risk.
