...
UAE banks offer mortgages to expat residents, but the loan-to-value (LTV) limits are stricter than the UK. The caps are set by the Central Bank of the UAE in [Regulations Regarding Mortgage Loans (Circular 31/2013)](https://rulebook.centralbank.ae/en/rulebook/regulations-regarding-mortgage-loans), Article 3.2, as amended in 2020:

| Property value | Expat first home / owner-occupier | Second or investment property |
|---|---|---|
| Up to AED 5 million | 80% | 60% |
| Over AED 5 million | 70% | 60% |
| Off-plan | 50% | 50% |

Each borrower can only claim one property under the first-home category, and the second-property cap is 60% regardless of value. These are ceilings, not entitlements — individual banks routinely lend less, and 75% on a first home is common in practice. Budget from the offer your bank actually makes, not from the regulation.

So for a AED 1.5 million completed property, the regulatory floor on your own funds is **AED 300,000** (20%), and **AED 375,000** if your bank holds you to 75%. Add the AED 110,000+ in transaction costs and you need **AED 410,000-485,000 of cash on day one.**
...
A UK-resident applicant buying a Dubai property remotely (without a UAE residence visa) is generally offered tighter LTVs — around 50% is commonly quoted — and higher rates. This is lender policy rather than a Central Bank rule: Circular 31/2013 sets no separate non-resident category, and the only regulatory 50% cap is the one on off-plan purchases. Most UK expats who buy do so as UAE residents, and the visa makes the maths materially better.
...
- Deposit: AED 400,000 (25% — the regulatory minimum for an expat first home is 20%, but this couple's bank offered 75% LTV)
...
3. **Single applicants without UAE residence visa.** Non-resident mortgages are typically offered at around 50% LTV by lender policy, deposit-heavy, and currency-exposed if you're earning in GBP.
...
Yes — UAE allows foreign property ownership without residence — but banks typically hold non-resident mortgages to around 50% LTV as a matter of lending policy, and the rates are 1-2 percentage points higher. Most UK expats who buy as non-residents end up wishing they'd done it as residents.
